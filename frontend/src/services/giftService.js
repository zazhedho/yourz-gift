...
const giftService = {
  ...
  listItems: (listId, params) => api.get(`/gift-lists/${listId}/items`, params ? { params } : undefined),
  ...
  cancelReservation: (reservationId, payload = {}) => api.post(`/gift-reservations/${reservationId}/cancel`, payload),
